...
import com.googlemaps.googlemapnotes.di.component.DaggerFragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as MapApplication).applicationComponent)
